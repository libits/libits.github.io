...
bind将前端传递的数据与结构体进行参数绑定，以及参数校验

学习于：https://docs.fengfengzhidao.com/#/docs/Gin%E6%A1%86%E6%9E%B6%E6%96%87%E6%A1%A3/4.bind%E7%BB%91%E5%AE%9A%E5%99%A8?id=bind%e7%bb%91%e5%ae%9a%e5%99%a8

##  参数绑定

在使用时，需要给结构体加上Tag  `json`,`form`,`uri`,`xml`,`yaml`
...
>当验证不通过时，会给出错误的信息，但是原始的错误信息不太友好，不利于用户查看,需要给结构体加一个msg 的tag
